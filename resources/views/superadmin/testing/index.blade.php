                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ route('superadmin.testing.create') }}" class="btn btn-success btn-sm"><i
                                            ...
                                            <tr data-entry-id="{{ $testing->id }}">
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm" role="group"
                                                        ...
                                                        <a href="{{ route('superadmin.testing.show', ['id' => $testing->id]) }}"
                                                            class="btn btn-info">View More</a>
                                                        &nbsp
                                                        <form
                                                            action="{{ route('superadmin.testing.edit', ['id' => $testing->id]) }}">
                                                        ...
                                                        &nbsp
                                                        <form
                                                            action="{{ route('superadmin.testing.destroy', ['id' => $testing->id]) }}"
