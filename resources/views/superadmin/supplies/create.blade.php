    ...
    <div class="container-fluid">
        ...
        <div class="card card-success">
            <div class="card-header">
                <h1 class="card-title"> Office Supplies</h1>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form action="{{ route('admin.supplies.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="serial_no[]" id="serial_no" class="form-control" multiple="multiple"
                                    style="width: 100%;">
                                </select>
                            </div>
                            <!-- Brand -->
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="unit" name="unit" data-placeholder="Select Unit"
                                style="width: 100%;">
                                <option>pcs</option>
                                <option>set</option>
                                <option>box</option>
                        ...
                        <div class="form-group">
                            ...
                            <label for="date_delivered" name="date_delivered" class="form-label">{{ 'Date Delivered'
                                }}</label>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12 text-right">
                                <button type="submit" class="btn btn-success bg-green-500 text-white">{{ __('Save')
                                    }}</button>
                                <a type="cancel" class="btn btn-danger" href="{{ url('/superadmin/supplies') }}">{{
                                    __('Exit') }}</a>
                            </div>
                            </form>
