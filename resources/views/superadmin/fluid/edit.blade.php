                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="condition"
                                                name="condition"value="{{ old('condition', $fluids->condition) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="unit" name="unit"
                                                value="{{ old('unit', $fluids->unit) }}"
                                                data-placeholder="{{ __('unit') }}" style="width: 100%;">
                                                <option value="unit"
                                                    {{ old('unit', $fluids->unit) == 'unit' ? 'selected' : '' }}>unit
                                                </option>
                                                <option value="pcs"
                                                    {{ old('unit', $fluids->unit) == 'pcs' ? 'selected' : '' }}>pcs
                                                </option>
                                                <option value="set"
                                                    {{ old('unit', $fluids->unit) == 'set' ? 'selected' : '' }}>set
                                                </option>
                                                <option value="box"
                                                    {{ old('unit', $fluids->unit) == 'box' ? 'selected' : '' }}>box
                                                </option>
                                                <option value="-"
                                                    {{ old('unit', $fluids->unit) == '-' ? 'selected' : '' }}>-</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!-- drscriptionm -->
