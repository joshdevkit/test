        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <form action="{{ route('superadmin.fluid.update', $fluids->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="equipment" name="equipment"
                                            value="{{ old('equipment', $fluids->equipment) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="brand" name="brand"
                                            value="{{ old('brand', $fluids->brand) }}" placeholder="{{ __('brand') }}">
                                    </div>
                                    <!-- Quantity -->
                                    <div class="form-group">
                                        <label for="exampleInputQuantity">{{ __('Quantity') }}</label>
                                        <input type="text" class="form-control" id="quantity" name="quantity"
                                            value="{{ old('quantity', $fluids->quantity) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="condition" name="condition"
                                            value="{{ old('condition', $fluids->condition) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="date_acquired" name="date_acquired"
                                            value="{{ old('date_acquired', $fluids->date_acquired) }}" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="unit" name="unit"
                                            value="{{ old('unit', $fluids->unit) }}" data-placeholder="{{ __('unit') }}"
                                            style="width: 100%;">
                                            <option value="unit" {{ old('unit', $fluids->unit) == 'unit' ? 'selected' :
                                                '' }}>unit
                                            </option>
                                            <option value="pcs" {{ old('unit', $fluids->unit) == 'pcs' ? 'selected' : ''
                                                }}>pcs
                                            </option>
                                            <option value="set" {{ old('unit', $fluids->unit) == 'set' ? 'selected' : ''
                                                }}>set
                                            </option>
                                            <option value="box" {{ old('unit', $fluids->unit) == 'box' ? 'selected' : ''
                                                }}>box
                                            </option>
                                            <option value="-" {{ old('unit', $fluids->unit) == '-' ? 'selected' : ''
                                                }}>-</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="description" name="description"
                                            ...
                                            style="width: 100%;">{{ old('description', $fluids->description) }}</textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12 text-right">
                                    <button type="submit" class="btn bg-green-500 text-white btn-success">{{
                                        __('Update') }}</button>
                                    <a type="cancel" class="btn btn-danger" href="{{ url('/superadmin/fluid') }}">{{
                                        __('Exit') }}</a>
...
<script>
    $(document).ready(function() {
            let itemIndex = {{ $fluids->items->count() }};
