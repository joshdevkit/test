                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped" id="example1">
                        ...
                        <tbody>
                            ...
                            <tr class="{{ $serial->borrow_status === 'Pending' ? 'pending-item' : '' }}
                                                {{ $serial->borrow_status === 'Declined' ? 'bg-warning' : '' }}
                                                {{ $serial->borrow_status === 'Received' ? 'bg-success' : '' }}
                                                ">
                                <td>
                                    <input type="checkbox" class="item-checkbox d-none" data-id="{{ $serial->id }}">
                                </td>
                                ...
                                <td>
                                    @if ($serial->borrow_status === 'Returned' && $serial->serialRelatedItem->condition
                                    !== 'Damaged')
                                    ...
                                    @endif
                                    @if (empty($serial->serialRelatedItem->notes) && $serial->borrow_status ===
                                    'Returned')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-10 mt-3 col-md-12">
                        ...
                        <form action="{{ url('/laboratory/update-requisition-details/' . $data->id) }}" method="POST"
                            ...
                            <div class="d-flex">
                                ...
                                <input type="hidden" name="requisition_id" id="requisition_id" value="{{ $data->id }}">
                                <button type="submit" class="btn btn-success text-black mr-3 approve">Approve</button>
                                <button type="button" class="btn btn-danger text-black mr-3 decline">Decline</button>
                                <button type="submit"
...
<div class="modal fade" id="itemReturnedModal" tabindex="-1" role="dialog" aria-labelledby="itemReturnedModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
