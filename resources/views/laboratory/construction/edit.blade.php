            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <form action="{{ route('constructions.update', $construction->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="condition"
                                                name="condition"value="{{ old('condition', $construction->condition) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="unit" name="unit"
                                                ...
                                                <option value="unit"
                                                    {{ old('unit', $construction->unit) == 'unit' ? 'selected' : '' }}>unit
                                                </option>
                                                <option value="pcs"
                                                    {{ old('unit', $construction->unit) == 'pcs' ? 'selected' : '' }}>pcs
                                                </option>
                                                <option value="set"
                                                    {{ old('unit', $construction->unit) == 'set' ? 'selected' : '' }}>set
                                                </option>
                                                <option value="box"
                                                    {{ old('unit', $construction->unit) == 'box' ? 'selected' : '' }}>box
                                                </option>
                                                <option value="-"
                                                    {{ old('unit', $construction->unit) == '-' ? 'selected' : '' }}>-
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12 text-right">
                                        ...
                                        <a type="cancel" class="btn btn-danger"
                                            href="{{ url('/constructions') }}">{{ __('Exit') }}</a>
